    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Ojala Healthcare Platform API",
                    Version = "v1",
                    Description = "API for the Ojala Healthcare Platform",
                    Contact = new Microsoft.OpenApi.Models.OpenApiContact
                    {
                        Name = "Ojala Healthcare",
                        Email = "support@ojala-healthcare.com",
                        Url = new Uri("https://ojala-healthcare.com")
                    }
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ojala Healthcare Platform API v1");
