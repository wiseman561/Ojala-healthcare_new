...
using Moq;
using Xunit;
using Ojala.Identity.Controllers;              // AuthController lives here
using Ojala.Identity.Services.Interfaces;     // IAuthService lives here
using Ojala.Identity.Models;
using Microsoft.Extensions.Logging;

namespace Ojala.Identity.Tests.Controllers
{
