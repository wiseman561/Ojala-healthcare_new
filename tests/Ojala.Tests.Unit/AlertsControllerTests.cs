...
using static Ojala.Api.Controllers.AlertsController;

namespace Ojala.Tests.Unit.Controllers
{
    public class AlertsControllerTests
    {
        ...
        private readonly DbContextOptions<OjalaDbContext> _dbOptions;
        ...
        public AlertsControllerTests()
        {
            ...
            _dbOptions = new DbContextOptionsBuilder<OjalaDbContext>()
        ...
        {
            // Arrange
            using var context = new OjalaDbContext(_dbOptions);
