...
using Moq;
using Moq.Protected;
using Ojala.Api.Services.Implementations;
...
namespace Ojala.Tests.Unit
{
    ...
    public class AIEngineClientTests
    {
        ...
        public AIEngineClientTests()
        {
            ...
            {
                BaseAddress = new Uri("https://ai-engine.ojala-healthcare.com/api")
            };
            
            // TODO: Replace mock URL with secrets from Vault
            _mockConfiguration.Setup(c => c["AIEngine:BaseUrl"]).Returns("https://ai-engine.ojala-healthcare.com/api");
