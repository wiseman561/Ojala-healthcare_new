...
namespace Ojala.Api.Services.Implementations
{
    /// <summary>
    ...
    public class AIEngineClient : IAIEngineClient
    {
            ...
            ILogger<AIEngineClient> logger)
        {
            ...
            // TODO: Replace with secrets from Vault in production
            _baseUrl = configuration["AIEngine:BaseUrl"] ?? "https://ai-engine.ojala-healthcare.com/api";
            _apiKey = configuration["AIEngine:ApiKey"] ?? "test-api-key";
