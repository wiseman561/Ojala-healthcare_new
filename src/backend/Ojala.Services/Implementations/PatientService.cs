    ...
    public class PatientService : IPatientService
    {
                ...
                Prescriptions = new List<PrescriptionDto>
        {
            new PrescriptionDto { Id = "rx1", PatientId = patientId, MedicationName = "Metformin", Dosage = "500mg", Frequency = "2x daily" }
                ...
                Vaccinations = new List<Ojala.Contracts.Models.VaccinationDto>
        {
            new Ojala.Contracts.Models.VaccinationDto
            {
                Id = "vac1",
                PatientId = patientId,
                ...
                VitalSigns = new List<Ojala.Contracts.Models.VitalSignsDto>
        {
            new Ojala.Contracts.Models.VitalSignsDto
            {
                Id = "vs1",
                PatientId = patientId,
